...
func VoteForPost(userid int64, p *models.PostVoteDate) error {

	zap.L().Debug("Vostpost :", zap.Int64("userid", userid), zap.String("postID", p.PostID), zap.Int8("Direction", p.Direction))
